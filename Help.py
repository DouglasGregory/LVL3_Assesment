...
class DisplayHelp:
    def __init__(self, partner):
        ...
        help_text = "This is a Questionnaire Related towards Greek Gods  " \
                    "In this Questionnaire you will be answering a selection" \
                    "of Questions depending on your choice, this will be" \
                    "To play this you will answer the question presented to you" \
                    "Answering these correctly will Improve your overall statistics"\
                    "\n\n" \
                    "To Start the Quiz please press start then put in how many rounds" \
                    "You wish to play." \
                    "" \
                    "" \
                    "" \
